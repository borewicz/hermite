...
{$IFDEF EnableHelperRoutines}
{$ASMMODE   intel}
  procedure ResetFPU; assembler;
  asm
    finit
  end;

       {$ASMMODE   intel}
  procedure ClearFPUExceptions; assembler;
  asm
    fnclex
  end;
       {$ASMMODE   intel}
  procedure CheckForFPUExceptions; assembler;
  asm
    fwait
  end;
       {$ASMMODE   intel}
  procedure ExitMMX; assembler;
  asm
    emms
  end;
     {$ASMMODE   intel}
  function IsST0Valid: boolean; assembler;
  asm
  ...
  asm
    ...
    {$ENDIF}
      ...
      {$ASMMODE   intel}
  procedure ExtX87SetFromMemory (var SrcExt87; out DstExt87: TExtendedX87); assembler;
  asm
    ...
    {$ENDIF}
       ...
       {$ASMMODE   intel}
  procedure ExtX87FetchST0AndPop (out DstExt: TExtendedX87); assembler;
  asm
    ...
    {$ENDIF}
       ...
       {$ASMMODE   intel}
  procedure ExtX87PushOntoST0 (var SrcExt87: TExtendedX87);   assembler;
  asm
    fld tbyte ptr [SrcExt87]
    {$IFDEF EnableFWAITsEverywhere}
     fwait
    {$ENDIF}
        ...
        {$ASMMODE   intel}
  procedure GetExtX87Pi (out Ext87: TExtendedX87); assembler;
  asm
    fldpi
    ...
    {$ENDIF}
      ...
      {$ASMMODE   intel}
  procedure GetExtX87One (out Ext87: TExtendedX87); assembler;
  asm
    fld1
    fstp tbyte ptr [Ext87]
    {$IFDEF EnableFWAITsEverywhere}
  ...
  {$ASMMODE   intel}
  procedure GetExtX87Zero (out Ext87: TExtendedX87); assembler;
  asm
    fldz
    fstp tbyte ptr [Ext87]
    {$IFDEF EnableFWAITsEverywhere}
  ...
  {$ASMMODE   intel}
  procedure GetExtX87Ld10 (out Ext87: TExtendedX87); assembler;
  asm
    fldl2t
    fstp tbyte ptr [Ext87]
    {$IFDEF EnableFWAITsEverywhere}
  ...
  {$ASMMODE   intel}
  procedure GetExtX87LdE (out Ext87: TExtendedX87); assembler;
  asm
    fldl2e
    fstp tbyte ptr [Ext87]
    {$IFDEF EnableFWAITsEverywhere}
  ...
  {$ASMMODE   intel}
  procedure GetExtX87Lg2 (out Ext87: TExtendedX87); assembler;
  asm
    fldlg2
    fstp tbyte ptr [Ext87]
    {$IFDEF EnableFWAITsEverywhere}
  ...
  {$ASMMODE   intel}
  procedure GetExtX87Ln2 (out Ext87: TExtendedX87);    assembler;
  asm
    fldln2
    fstp tbyte ptr [Ext87]
    {$IFDEF EnableFWAITsEverywhere}
  ...
  {$ASMMODE   intel}
  function Ext2Dbl (Const Ext87: TExtendedX87): double;  assembler;
  asm
    fld tbyte ptr [Ext87]
   {$IFDEF Win64}
    fstp qword ptr [rsp+08h]
  ...
  {$ASMMODE   intel}
  function Ext2Sgl (const Ext87: TExtendedX87): single; assembler;
  asm
    fld tbyte ptr [Ext87]
   {$IFDEF Win64}
    fstp dword ptr [rsp+08h]
  ...
  {$ASMMODE   intel}
  function Sgl2Ext (const Sgl: single): TExtendedX87; assembler;
  asm
   {$IFDEF Win64}
    movss [rsp+08h], xmm1
  ...
  {$ASMMODE   intel}
  function Dbl2Ext (const Dbl: double): TExtendedX87; assembler;
  asm
   {$IFDEF Win64}
    movsd [rsp+08h], xmm1
...
{ ***** Replacement rountines for standard System.pas rountines for Win32/Win64 *****}
 {$ASMMODE   intel}
{$IF defined(CPUX64) or defined(DontUseSystemUnitOn32bit)}
  function abs (const Val: TExtendedX87): TExtendedX87;  assembler;
  asm
    fld tbyte ptr [Val]
    fabs
   {$IFDEF Win64}
   ...
   {$ASMMODE   intel}
  function round (const Val: TExtendedX87): Int64; assembler;
  var
    TmpVal: Int64;
  asm
   ...
   {$ENDIF}
          ...
          {$ASMMODE   intel}
  function trunc (const Val: TExtendedX87): Int64; assembler;
  var
    TmpVal: Int64;
  ...
  asm
   ...
   {$ASMMODE   intel}
  function int (const X: TExtendedX87): TExtendedX87; assembler;
  var
    SaveCW, ScratchCW: word;
  asm
   {$IFDEF Win64} .NOFRAME {$ENDIF}
   ...
   {$ASMMODE   intel}
  function frac(const X: TExtendedX87): TExtendedX87; assembler;
  var
    SaveCW, ScratchCW: word;
  asm
   {$IFDEF Win64} .NOFRAME {$ENDIF}
   ...
   {$ASMMODE   intel}
  function exp (const X: TExtendedX87): TExtendedX87;    assembler;
  asm
  ...
  {$ASMMODE   intel}
  function cos (const X: TExtendedX87): TExtendedX87;  assembler;
  asm
    fld tbyte ptr [X]
    fcos
   {$IFDEF Win64}
   ...
   {$ASMMODE   intel}
  function sin (const X: TExtendedX87): TExtendedX87; assembler;
  asm
    fld tbyte ptr [X]
    fsin
   {$IFDEF Win64}
  ...
  {$ASMMODE   intel}
  function ln (const X: TExtendedX87): TExtendedX87;  assembler;
  asm
    fldln2
    fld tbyte ptr [X]
    fyl2x
  ...
  {$ASMMODE   intel}
  function arctan (const X: TExtendedX87): TExtendedX87;  assembler;
  asm
    fld tbyte ptr [x]
    fld1
    fpatan
  ...
  {$ASMMODE   intel}
  function sqrt (const X: TExtendedX87): TExtendedX87; assembler;
  asm
    fld tbyte ptr [x]
    fsqrt
   {$IFDEF Win64}
